package gregtech.common.metatileentities.electric.energyconverter;
...
import gregtech.common.metatileentities.electric.energyconverter.energy.UniversalEnergyStorage;
...
public class MetaTileEntityEnergyConverter extends TieredMetaTileEntity implements EnergyConverterCharger {
	...
	public void renderMetaTileEntity(final CCRenderState renderState, final Matrix4 translation, final IVertexOperation[] pipeline) {
		...
		Textures.CONVERTER_FACES.get(this.type).renderSided(this.getFrontFacing(), renderState, translation, pipeline);
	}
