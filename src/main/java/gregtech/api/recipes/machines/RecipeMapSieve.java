...
public class RecipeMapSieve extends RecipeMap<SimpleRecipeBuilder> {
    ...
    public RecipeMapSieve(
        String unlocalizedName, int minInputs, int maxInputs, int minOutputs, int maxOutputs, int minFluidInputs, int maxFluidInputs, int minFluidOutputs, int maxFluidOutputs, SimpleRecipeBuilder defaultRecipe) {
